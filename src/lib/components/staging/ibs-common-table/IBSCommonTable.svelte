...
<table
    class="table w-full table-fixed border-collapse border border-ios-labelColors-separator-light"
>
    <!-- table head starts -->
            ...
            {#each Object.keys(tableData[0]) as columnHeading}
                ...
                <th
                    on:click={() => {
                        ...
                        handleSort(Object.values({ columnHeading }).toString());
                    }}
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                {:else}
                                    <SvgSortDown size="18"></SvgSortDown>
                                {/if}
                            </div>
                        </div>
                    </div>
    ...
    <tbody>
        ...
        {#each Object.values(tableData) as row}
            <tr class=" h-10 bg-ios-backgroundColors-systemBackground-light">
