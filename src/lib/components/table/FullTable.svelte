...
<div class="flex h-full w-full flex-col items-start justify-start border-t">
    <!-- table header -->
    <div
        class="flex h-fit min-h-16 w-full flex-row items-center justify-start border-b px-10"
    >
        <!-- filter area -->
        <div
            class="flex h-fit min-h-full w-full flex-row flex-wrap items-end justify-start gap-2"
        ></div>

        <!-- export area -->
        <div class="flex h-full w-fit flex-row items-start justify-end gap-2">
    ...
    <!-- table area -->
    <div
        class="flex h-full w-full flex-col items-start justify-start overflow-x-auto"
    >
            ...
            <table class="table h-fit w-full table-auto">
                ...
                <tbody>
                    ...
                    {#each Object.values(tableData.data) as row, index}
                        <tr
                            class=" h-10 border-b bg-ios-backgroundColors-systemBackground-light hover:bg-ios-systemColors-systemGrey6-light"
                        >
                            {#if tableData.option.checkbox}
    ...
    {#if tableData.option.footer}
        <div
            class="flex h-16 min-h-16 w-full flex-row items-center justify-between rounded-bl rounded-br border-t bg-white px-10"
        >
            <!-- leading -->
