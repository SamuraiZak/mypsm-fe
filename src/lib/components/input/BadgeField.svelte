...
{#if labelType === 'default'}
    <div class="flex w-full flex-row items-center justify-between">
        ...
        <div class="flex w-full flex-row gap-2.5">
            <Badge
                class="bg-system-green text-txt-onGreen h-[30px] text-sm font-bold leading-loose"
                rounded>DISOKONG</Badge
            >
        </div>
    </div>
{:else if labelType === 'unsupported'}
    <div class="flex w-full flex-row items-center">
        ...
        <Badge
            class="bg-system-red  text-txt-onRed h-[30px] text-sm font-bold leading-loose"
            rounded>TIDAK DISOKONG</Badge
        >
    </div>
{:else if labelType === 'inProgress'}
    <div class="flex w-full flex-row items-center">
        <div
            class="w-[220px] min-w-[220px] flex-row gap-2 {label == ''
                ? 'hidden'
        ...
        <Badge
            class="bg-system-blue text-txt-onBlue h-[30px] text-sm font-bold leading-loose"
            rounded>DALAM PROSES</Badge
        >
    </div>
