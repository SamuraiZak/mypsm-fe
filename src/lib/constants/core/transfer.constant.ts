...
export class TransferSelfStatusConstant {
    public static step0: LookupDTO = {
        id: 0,
        code: 'step0',
        description: 'Baru',
    ...
    public static step1: LookupDTO = {
        id: 1,
        code: 'step1',
        description: 'Menunggu kakitangan menambah alasan pertukaran',
    };
    public static step2: LookupDTO = {
        id: 2,
        code: 'step2',
        description: 'Menunggu pengesahan kakitangan',
    };
    public static step3: LookupDTO = {
        id: 3,
        code: 'step3',
        description: 'Menunggu dokumen sokongan kakitangan',
    };
    public static step4: LookupDTO = {
        id: 4,
        code: 'step4',
...
export class TransferReasonConstant {
    public static followPartner: LookupDTO = {
        id: 1,
        code: '01',
        description: 'Mengikut Pasangan',
    };
    public static parents: LookupDTO = {
        id: 2,
        code: '02',
        description: 'Menjaga Ibu atau Bapa yang uzur atau sakit',
    };
    public static safety: LookupDTO = {
        id: 3,
        code: '03',
        description: 'Ancaman Keselamatan',
    };
    public static others: LookupDTO = {
        id: 4,
        code: '04',
