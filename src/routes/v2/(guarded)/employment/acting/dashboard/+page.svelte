<script lang="ts">
    ...
    let menu: DropdownDTO[] = [
        {
            name: 'Tawaran Memangku',
            value: '/v2/employment/acting/offer',
        },
        {
            name: 'Senarai Sejarah Memangku',
            value: '/v2/employment/acting/dashboard',
        },
        {
            name: 'Pengurusan Pemangkuan Baharu',
            value: '/v2/employment/acting/dashboard',
        },
        {
            name: 'Perkara-perkara Yang Memerlukan Tindakan Anda',
            value: '/v2/employment/acting/dashboard',
        },
    ];
</script>
...
<section
    ...
    to bottom, transparent, #555555
  ), url('/src/lib/assets/images/office-chair.jpg');"
>
    <div
...
>
    <div class="h-full w-full overflow-y-auto overflow-x-hidden px-5">
        ...
        >
            {#each menu as module}
                <a data-sveltekit-preload-data="false" href={module.value}>
                    <div
                        class="flex h-full min-w-20 transform flex-col items-start justify-start gap-2 overflow-hidden rounded-md border bg-white p-4 shadow transition-transform hover:shadow-lg"
                    >
                        <div
