<script lang="ts">
    ...
    $: {
        ...
        if (data.newHireFullDetailView.experience.isDraft === true) {
        ...
        if (data.newHireFullDetailView.document.isDraft === true) {
            documentFormStepperIsDraft.set(true);
        } else {
            documentFormStepperIsDraft.set(false);
        }

        if (data.newHireFullDetailView.document.isReadonly === true) {
            isReadonlyDocumentFormStepper.set(true);
        } else {
            isReadonlyDocumentFormStepper.set(false);
        }

        if (data.newHireFullDetailView.secretaryUpdate.isDraft === true) {
        ...
        if (data.newHireFullDetailView.supporterApprover.isDraft === true) {
    ...
    if (data.roles.isCandidateRole) {
        isStatusNew = data.candidateViewTable[0]?.status === 'Sedang diproses';
    } else if (data.roles.isEmploymentSecretaryRole) {
        isStatusNew =
            data.newHireStatusResponse.data?.details.status ===
            'Sedang diproses';
    }
    // Stepper Classes
    ...
    const {
        ...
        onChange() {
            ...
            $serviceInfoForm.serviceTypeId = 2;
        },
        onSubmit() {
            // $serviceInfoForm.retirementDate = setRetirementYear(
            //     $serviceInfoForm.retirementAge,
            ...
            // );
            // $serviceInfoForm.serviceTypeId = 2;
            _submitServiceForm(Number(data.params.id), $serviceInfoForm);
        },
    });
...
<ContentHeader title="Maklumat Lantikan Baharu">
        ...
        <StepperContentBody
            ...
            >
                ...
                <CustomSelectField
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    bind:errors={$errors.identityDocumentColor}
                ...
                <CustomSelectField
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    bind:errors={$errors.birthStateId}
                    id="birthStateId"
                ...
                <CustomSelectField
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    bind:errors={$errors.birthCountryId}
                    id="birthCountryId"
                ...
                <CustomSelectField
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    bind:errors={$errors.nationalityId}
                    id="nationalityId"
                    label="Warganegara"
                ...
                <CustomTextField
                    placeholder="-"
                    bind:errors={$errors.homeAddress}
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    id="homeAddress"
                    label="Alamat Rumah"
                ...
                <CustomSelectField
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    bind:errors={$errors.homeCountryId}
                    id="homeCountryId"
                ...
                <CustomSelectField
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    bind:errors={$errors.homeStateId}
                    id="homeStateId"
                ...
                <CustomTextField
                    placeholder="-"
                    bind:errors={$errors.homePostcode}
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    id="homePostcode"
                    label="Poskod Rumah"
                ...
                <CustomTextField
                    placeholder="-"
                    bind:errors={$errors.mailAddress}
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    id="mailAddress"
                ...
                <CustomSelectField
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    bind:errors={$errors.mailCountryId}
                    id="mailCountryId"
                ...
                <CustomSelectField
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    bind:errors={$errors.mailStateId}
                    id="mailStateId"
                ...
                <CustomTextField
                    placeholder="-"
                    bind:errors={$errors.mailPostcode}
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    id="mailPostcode"
                ...
                <!-- <CustomSelectField
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    bind:errors={$errors.retirementBenefit}
                ...
                <CustomTextField
                    ...
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    bind:errors={$errors.bankAccount}
                    id="bankAccount"
                    label={'No. Akaun'}
                ...
                <CustomTextField
                    ...
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    bind:errors={$errors.socsoNumber}
                    id="socsoNumber"
                    label={'No. SOCSO'}
                ...
                <CustomTextField
                    ...
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    bind:errors={$errors.incomeNumber}
                    id="incomeNumber"
                    label={'No. Cukai'}
                ...
                <CustomSelectField
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    bind:errors={$errors.assetDeclarationStatusId}
                    isRequired={false}
                ...
                {#if $form.assetDeclarationStatusId === 12 || $form.assetDeclarationStatusId === 14 || $form.assetDeclarationStatusId === 15 || $form.assetDeclarationStatusId === 17 || $form.assetDeclarationStatusId === 18 || $form.assetDeclarationStatusId === 22}
                    <CustomTextField
                        placeholder="-"
                        bind:errors={$errors.propertyDeclarationDate}
                        disabled={$isReadonlyPersonalFormStepper &&
                            !$personalFormStepperIsDraft}
                ...
                <CustomSelectField
                    disabled={$isReadonlyPersonalFormStepper &&
                        !$personalFormStepperIsDraft}
                    bind:errors={$errors.isExPoliceOrSoldier}
                ...
                <div class="flex w-full flex-col gap-2">
                    ...
                    <CustomSelectField
                        disabled={$isReadonlyPersonalFormStepper &&
                            !$personalFormStepperIsDraft}
                        bind:errors={$errors.isInternalRelationship}
                    ...
                    {#if $form.isInternalRelationship}
                        ...
                        <CustomSelectField
                            disabled={$isReadonlyPersonalFormStepper &&
                                !$personalFormStepperIsDraft}
                            bind:errors={$errors.relationshipId}
        ...
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                ...
                {:else if (!$isReadonlyDocumentFormStepper || $documentFormStepperIsDraft) && data.roles.isCandidateRole}
                        ...
                        >
                            <div class="flex flex-wrap gap-3">
                                {#each $documentForm.document as _, i}
                                    ...
                                    />
                                {/each}
                                <!-- {#if data.newHireFullDetailView.document.attachment !== null && $documentForm.document.length < 1}
                                    <div class="flex flex-row">
                                        ...
                                        >
                                            ...
                                            >
                                            {#if data.newHireFullDetailView.document.attachmentName.length < 15}
                                                {data.newHireFullDetailView
                                                    .document.attachmentName}
                                            {:else}
                                                {data.newHireFullDetailView.document.attachmentName.substring(
                                                    0,
                                                    15,
                                                ) + '...'}
                                            {/if}
                    ...
                    {#if data.newHireFullDetailView.document.attachment !== null}
                        <div
                        ...
                        >
                            ...
                            >
                                ...
                                <a
                                    href={data.newHireFullDetailView.document
                                        .attachment}
                                    download={data.newHireFullDetailView
                                        .document.attachmentName}
                ...
                {:else}
                    ...
                    >
                        <CustomSelectField
                            ...
                            bind:errors={$serviceInfoErrors.gradeId}
                            id="gradeId"
                            label="Gred Semasa"
                        ...
                        <CustomSelectField
                            disabled={$isReadonlyServiceFormStepper &&
                                !$serviceFormStepperIsDraft}
                            bind:errors={$serviceInfoErrors.maxGradeId}
                            id="maxGradeId"
                            label="Gred Maksimum"
                        ...
                        <CustomSelectField
                            disabled={$isReadonlyServiceFormStepper &&
                                !$serviceFormStepperIsDraft}
                            bind:errors={$serviceInfoErrors.placementId}
                            id="placementId"
                            label="Penempatan"
                        ...
                        <CustomSelectField
                            disabled={true}
                            bind:errors={$serviceInfoErrors.serviceTypeId}
                            id="serviceTypeId"
                        ...
                        <CustomSelectField
                            disabled={$isReadonlyServiceFormStepper &&
                                !$serviceFormStepperIsDraft}
                            bind:errors={$serviceInfoErrors.serviceGroupId}
                            id="serviceGroupId"
                        ...
                        <CustomSelectField
                            disabled={$isReadonlyServiceFormStepper &&
                                !$serviceFormStepperIsDraft}
                            bind:errors={$serviceInfoErrors.unitId}
                            id="unitId"
                        ...
                        <CustomTextField
                            ...
                            disabled={$isReadonlyServiceFormStepper &&
                                !$serviceFormStepperIsDraft}
                            bind:errors={$serviceInfoErrors.effectiveDate}
                            id="effectiveDate"
                        ...
                        <CustomTextField
                            ...
                            disabled={$isReadonlyServiceFormStepper &&
                                !$serviceFormStepperIsDraft}
                            bind:errors={$serviceInfoErrors.civilServiceStartDate}
                        ...
                        <CustomTextField
                            ...
                            disabled={$isReadonlyServiceFormStepper &&
                                !$serviceFormStepperIsDraft}
                            bind:errors={$serviceInfoErrors.serviceDate}
                            id="serviceDate"
                        ...
                        <CustomTextField
                            ...
                            disabled={$isReadonlyServiceFormStepper &&
                                !$serviceFormStepperIsDraft}
                            bind:errors={$serviceInfoErrors.newRecruitEffectiveDate}
                        ...
                        <CustomTextField
                            ...
                            disabled={$isReadonlyServiceFormStepper &&
                                !$serviceFormStepperIsDraft}
                            bind:errors={$serviceInfoErrors.retirementAge}
                            id="retirementAge"
                            label={'Umur Bersara'}
                        ...
                        <CustomTextField
                            ...
                            type="date"
                            disabled
                            bind:errors={$serviceInfoErrors.retirementDate}
                            id="retirementDate"
                        ...
                        <!-- <CustomTextField
                            ...
                            disabled={$isReadonlyServiceFormStepper &&
                                !$serviceFormStepperIsDraft}
                            bind:errors={$serviceInfoErrors.pensionNumber}
                            id="pensionNumber"
                            label={'Nombor Pencen'}
                        ...
                        <div class="grid grid-cols-2 gap-10">
                            <div class="space-y-2.5">
                                <CustomSelectField
                                    disabled={$isReadonlyServiceFormStepper &&
                                        !$serviceFormStepperIsDraft}
                                    bind:errors={$serviceInfoErrors.revisionMonthId}
                                    id="revisionMonthId"
                                ...
                                <CustomTextField
                                    ...
                                    disabled
                                    isRequired={false}
                                    bind:errors={$serviceInfoErrors.kgt}
                                    id="kgt"
                                    type="number"
                                    label={'KGT (RM)'}
                                ...
                                <CustomTextField
                                    ...
                                    disabled
                                    isRequired={false}
                                    bind:errors={$serviceInfoErrors.maximumSalary}
                                    id="maximumSalary"
                                    type="number"
                            ...
                            <div class="space-y-2.5">
                                <CustomTextField
                                    ...
                                    disabled={$isReadonlyServiceFormStepper &&
                                        !$serviceFormStepperIsDraft}
                                    bind:errors={$serviceInfoErrors.itka}
                                    id="itka"
                                    label={'ITKA (RM)'}
                                    type="number"
                                ...
                                <CustomTextField
                                    ...
                                    disabled={$isReadonlyServiceFormStepper &&
                                        !$serviceFormStepperIsDraft}
                                    bind:errors={$serviceInfoErrors.itp}
                                    id="itp"
                                    label={'ITP (RM)'}
                                    type="number"
                                ...
                                <CustomTextField
                                    ...
                                    disabled={$isReadonlyServiceFormStepper &&
                                        !$serviceFormStepperIsDraft}
                                    bind:errors={$serviceInfoErrors.epw}
                                    id="epw"
                                    label={'EPW (RM)'}
                                    type="number"
                                ...
                                <CustomTextField
                                    ...
                                    disabled={$isReadonlyServiceFormStepper &&
                                        !$serviceFormStepperIsDraft}
                                    bind:errors={$serviceInfoErrors.cola}
                                    id="cola"
                                    label={'COLA (RM)'}
                                    type="number"
                    ...
                    {:else}
                        ...
                        >
                            ...
                            <CustomTextField
                                ...
                                bind:errors={$secretaryApprovalInfoErrors.remark}
                                id="remark"
                            ...
                            <CustomRadioBoolean
                                disabled={$isReadonlySecretaryApprovalResult &&
                                    !$secretaryApprovalResultIsDraft}
                                bind:errors={$secretaryApprovalInfoErrors.status}
                                id="status"
                        ...
                        >
                            <CustomSelectField
                                disabled={$isReadonlySetApproversFormStepper &&
                                    !$setApproversFormStepperIsDraft}
                            ...
                            <CustomSelectField
                                disabled={$isReadonlySetApproversFormStepper &&
                                    !$setApproversFormStepperIsDraft}
                                bind:errors={$secretarySetApproverErrors.approverId}
                                id="approverId"
                                label="Nama Pelulus"
                                options={data.selectionOptions.employeeLookup}
                                    ...
                                    {#if data.layoutData.accountDetails.identityDocumentNumber == data.newHireFullDetailView.supporter.identityDocumentNumber}
                                        ...
                                        >
                                            ...
                                            <CustomTextField
                                                ...
                                                bind:errors={$supporterApprovalErrors.remark}
                                                id="supporterRemark"
                                                label="Tindakan/Ulasan"
                                            ...
                                            <CustomRadioBoolean
                                                disabled={$isReadonlySupporterApprovalResult &&
                                                    !$supporterApprovalResultIsDraft}
                                                bind:errors={$supporterApprovalErrors.status}
                                    ...
                                    {#if data.layoutData.accountDetails.identityDocumentNumber == data.newHireFullDetailView.approver.identityDocumentNumber}
                                        ...
                                        >
                                            ...
                                            <CustomTextField
                                                ...
                                                bind:errors={$approverApprovalErrors.remark}
                                                id="approverRemark"
                                                label="Tindakan/Ulasan"
...
>
    ...
    >
        <CustomSelectField
            bind:errors={$addAcademicInfoErrors.educationLevelId}
            id="educationLevelId"
            label={'Taraf Pendidikan'}
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addAcademicInfoErrors.institution}
            id="institution"
            label={'Institusi'}
        ...
        <CustomSelectField
            bind:errors={$addAcademicInfoErrors.majorId}
            id="majorId"
            label={'Jenis Jurusan'}
        ...
        <CustomSelectField
            bind:errors={$addAcademicInfoErrors.minorId}
            id="minorId"
            label={'Jenis Bidang'}
            options={data.selectionOptions.majorMinorLookup}
        ...
        <CustomSelectField
            bind:errors={$addAcademicInfoErrors.countryId}
            id="countryId"
            label={'Negara'}
            options={data.selectionOptions.countryLookup}
        ...
        <CustomSelectField
            bind:errors={$addAcademicInfoErrors.sponsorshipId}
            id="sponsorshipId"
            label={'Penajaan'}
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addAcademicInfoErrors.name}
            id="name"
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addAcademicInfoErrors.completionDate}
            id="completionDate"
            label="Tarikh Kelulusan"
            type="date"
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addAcademicInfoErrors.finalGrade}
            id="finalGrade"
        ...
        <CustomTextField
            placeholder="-"
            isRequired={false}
            bind:errors={$addAcademicInfoErrors.field}
            id="field"
            label={'Catatan'}
...
<Modal title={'Tambah Maklumat Pengalaman'} bind:open={openExperienceInfoModal}>
    ...
    >
        <CustomTextField
            placeholder="-"
            bind:errors={$addExperienceModalErrors.company}
            id="company"
            label={'Nama Majikan'}
            type="text"
        ...
        <CustomTextField
            placeholder="-"
            isRequired={false}
            bind:errors={$addExperienceModalErrors.address}
            id="address"
            label={'Alamat Majikan'}
            type="text"
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addExperienceModalErrors.position}
            id="position"
            label={'Jawatan'}
            type="text"
        ...
        <CustomTextField
            placeholder="-"
            isRequired={false}
            bind:errors={$addExperienceModalErrors.positionCode}
            id="positionCode"
            label={'Kod Jawatan'}
            type="text"
        ...
        <CustomTextField
            placeholder="-"
            type="date"
            bind:errors={$addExperienceModalErrors.startDate}
            id="startDate"
            label={'Tarikh Mula Bekerja'}
        ...
        <CustomTextField
            placeholder="-"
            type="date"
            bind:errors={$addExperienceModalErrors.endDate}
            id="endDate"
            label={'Tarikh Tamat Bekerja'}
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addExperienceModalErrors.salary}
            id="salary"
            label={'Gaji'}
            type="text"
...
<Modal title={'Tambah Kegiatan/Keahlian'} bind:open={openMembershipInfoModal}>
    ...
    >
        <CustomTextField
            placeholder="-"
            bind:errors={$addActivityModalErrors.name}
            id="name"
            label={'Nama Kegiatan'}
            type="text"
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addActivityModalErrors.joinDate}
            id="joinDate"
            type="date"
            label={'Tarikh Keahlian'}
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addActivityModalErrors.position}
            id="position"
            label={'Jawatan'}
            type="text"
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addActivityModalErrors.description}
            id="description"
            label={'Catatan'}
            type="text"
...
>
    ...
    >
        <CustomTextField
            placeholder="-"
            bind:errors={$addFamilyErrors.name}
            id="nameSuamiIsteri"
            label={'Nama'}
            type="text"
        ...
        <CustomTextField
            placeholder="-"
            isRequired={false}
            bind:errors={$addFamilyErrors.alternativeName}
            id="alternativeName"
            label={'Nama Lain'}
            type="text"
        ...
        ></CustomTextField>
        <CustomSelectField
            bind:errors={$addFamilyErrors.identityDocumentColor}
            id="identityDocumentColor"
            label={'Jenis Kad Pengenalan'}
            options={data.selectionOptions.identityCardColorLookup}
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addFamilyErrors.identityDocumentNumber}
            id="identityDocumentNumber"
            type="text"
            label={'Nombor Kad Pengenalan'}
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addFamilyErrors.address}
            id="address"
            label={'Alamat'}
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addFamilyErrors.postcode}
            id="postcode"
            label={'Poskod'}
            type="text"
        ...
        <CustomTextField
            ...
            type="date"
            isRequired={false}
            bind:errors={$addFamilyErrors.birthDate}
            id="birthDate"
            label={'Tarikh Lahir'}
        ...
        <CustomSelectField
            bind:errors={$addFamilyErrors.birthCountryId}
            id="birthCountryId"
            label={'Negara Kelahiran'}
            options={data.selectionOptions.countryLookup}
        ...
        <CustomSelectField
            bind:errors={$addFamilyErrors.birthStateId}
            id="birthStateId"
            label={'Negeri Kelahiran'}
            options={data.selectionOptions.stateLookup}
        ...
        <CustomSelectField
            bind:errors={$addFamilyErrors.relationshipId}
            id="relationshipId"
            label={'Hubungan'}
        ...
        <CustomSelectField
            bind:errors={$addFamilyErrors.educationLevelId}
            id="educationLevelId"
            label={'Taraf Pendidikan'}
            options={data.selectionOptions.educationLookup}
        ...
        <CustomSelectField
            bind:errors={$addFamilyErrors.raceId}
            id="raceId"
            label={'Bangsa'}
            options={data.selectionOptions.raceLookup}
        ...
        <CustomSelectField
            bind:errors={$addFamilyErrors.nationalityId}
            id="nationalityId"
            label={'Kewarganegaraan'}
            options={data.selectionOptions.nationalityLookup}
        ...
        <CustomSelectField
            bind:errors={$addFamilyErrors.genderId}
            id="genderId"
            label={'Jantina'}
            options={data.selectionOptions.genderLookup}
        ...
        <CustomTextField
            placeholder="-"
            isRequired={false}
            bind:errors={$addFamilyErrors.workAddress}
            id="workAddress"
            label={'Alamat Majikan'}
            type="text"
        ...
        <CustomTextField
            placeholder="-"
            isRequired={false}
            bind:errors={$addFamilyErrors.workPostcode}
            id="workPostcode"
            label={'Poskod Majikan'}
            type="text"
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addFamilyErrors.phoneNumber}
            id="phoneNumber"
            label={'Nombor Telefon'}
            type="text"
        ...
        <CustomSelectField
            bind:errors={$addFamilyErrors.maritalId}
            id="maritalId"
            label={'Status Perkahwinan'}
            options={data.selectionOptions.maritalLookup}
        ...
        {#if $addFamilyModal.maritalId === 3}
            <CustomTextField
                ...
                isRequired={false}
                type="date"
                bind:errors={$addFamilyErrors.marriageDate}
                id="marriageDate"
                label={'Tarikh Kahwin'}
...
>
    ...
    >
        <CustomTextField
            placeholder="-"
            bind:errors={$addNonFamilyErrors.name}
        ...
        <CustomTextField
            placeholder="-"
            isRequired={false}
            bind:errors={$addNonFamilyErrors.alternativeName}
            id="alternativeName"
            label={'Nama Lain'}
            type="text"
        ...
        ></CustomTextField>
        <CustomSelectField
            bind:errors={$addNonFamilyErrors.identityDocumentColor}
            id="identityDocumentColor"
            label={'Jenis Kad Pengenalan'}
            options={data.selectionOptions.identityCardColorLookup}
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addNonFamilyErrors.identityDocumentNumber}
            id="identityDocumentNumber"
            type="text"
            label={'Nombor Kad Pengenalan'}
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addNonFamilyErrors.address}
            id="address"
            label={'Alamat'}
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addNonFamilyErrors.postcode}
            id="postcode"
            label={'Poskod'}
            type="text"
        ...
        <CustomTextField
            ...
            type="date"
            isRequired={false}
            bind:errors={$addNonFamilyErrors.birthDate}
            id="birthDate"
            label={'Tarikh Lahir'}
        ...
        <CustomSelectField
            bind:errors={$addNonFamilyErrors.birthCountryId}
            id="birthCountryId"
            label={'Negara Kelahiran'}
            options={data.selectionOptions.countryLookup}
        ...
        <CustomSelectField
            bind:errors={$addNonFamilyErrors.birthStateId}
            id="birthStateId"
            label={'Negeri Kelahiran'}
            options={data.selectionOptions.stateLookup}
        ...
        <CustomSelectField
            bind:errors={$addNonFamilyErrors.relationshipId}
            id="relationshipId"
            label={'Hubungan'}
        ...
        <CustomSelectField
            bind:errors={$addNonFamilyErrors.educationLevelId}
            id="educationLevelId"
            label={'Taraf Pendidikan'}
            options={data.selectionOptions.educationLookup}
        ...
        <CustomSelectField
            bind:errors={$addNonFamilyErrors.raceId}
            id="raceId"
            label={'Bangsa'}
            options={data.selectionOptions.raceLookup}
        ...
        <CustomSelectField
            bind:errors={$addNonFamilyErrors.nationalityId}
            id="nationalityId"
            label={'Kewarganegaraan'}
            options={data.selectionOptions.nationalityLookup}
        ...
        <CustomSelectField
            bind:errors={$addNonFamilyErrors.genderId}
            id="genderId"
            label={'Jantina'}
            options={data.selectionOptions.genderLookup}
        ...
        <CustomTextField
            placeholder="-"
            isRequired={false}
            bind:errors={$addNonFamilyErrors.workAddress}
            id="workAddress"
            label={'Alamat Majikan'}
            type="text"
        ...
        <CustomTextField
            placeholder="-"
            isRequired={false}
            bind:errors={$addNonFamilyErrors.workPostcode}
            id="workPostcode"
            label={'Poskod Majikan'}
            type="text"
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addNonFamilyErrors.phoneNumber}
            id="phoneNumber"
            label={'Nombor Telefon'}
            type="text"
        ...
        <CustomSelectField
            bind:errors={$addNonFamilyErrors.maritalId}
            id="maritalId"
            label={'Status Perkahwinan'}
            options={data.selectionOptions.maritalLookup}
        ...
        {#if $addNonFamilyModal.maritalId === 3}
            <CustomTextField
                ...
                isRequired={false}
                type="date"
                bind:errors={$addNonFamilyErrors.marriageDate}
                id="marriageDate"
                label={'Tarikh Kahwin'}
...
<Modal title={'Tambah Maklumat Waris'} bind:open={openNextOfKinInfoModal}>
    ...
    >
        <CustomTextField
            placeholder="-"
            bind:errors={$addNextOfKinErrors.name}
            id="name"
            label={'Nama'}
            type="text"
        ...
        <CustomTextField
            placeholder="-"
            isRequired={false}
            bind:errors={$addNextOfKinErrors.alternativeName}
            id="alternativeName"
            label={'Nama Lain'}
            type="text"
        ...
        ></CustomTextField>
        <CustomSelectField
            bind:errors={$addNextOfKinErrors.identityDocumentColor}
            id="identityDocumentColor"
            label={'Jenis Kad Pengenalan'}
            options={data.selectionOptions.identityCardColorLookup}
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addNextOfKinErrors.identityDocumentNumber}
            id="identityDocumentNumber"
            type="text"
            label={'Nombor Kad Pengenalan'}
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addNextOfKinErrors.address}
            id="address"
            label={'Alamat'}
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addNextOfKinErrors.postcode}
            id="postcode"
            label={'Poskod'}
            type="text"
        ...
        <CustomTextField
            ...
            type="date"
            isRequired={false}
            bind:errors={$addNextOfKinErrors.birthDate}
            id="birthDate"
            label={'Tarikh Lahir'}
        ...
        <CustomSelectField
            bind:errors={$addNextOfKinErrors.birthCountryId}
            id="birthCountryId"
            label={'Negara Kelahiran'}
            options={data.selectionOptions.countryLookup}
        ...
        <CustomSelectField
            bind:errors={$addNextOfKinErrors.birthStateId}
            id="birthStateId"
            label={'Negeri Kelahiran'}
            options={data.selectionOptions.stateLookup}
        ...
        <CustomSelectField
            bind:errors={$addNextOfKinErrors.relationshipId}
            id="relationshipId"
            label={'Hubungan'}
            options={data.selectionOptions.relationshipLookup}
        ...
        <CustomSelectField
            bind:errors={$addNextOfKinErrors.educationLevelId}
            id="educationLevelId"
            label={'Taraf Pendidikan'}
            options={data.selectionOptions.educationLookup}
        ...
        <CustomSelectField
            bind:errors={$addNextOfKinErrors.raceId}
            id="raceId"
            label={'Bangsa'}
            options={data.selectionOptions.raceLookup}
        ...
        <CustomSelectField
            bind:errors={$addNextOfKinErrors.nationalityId}
            id="nationalityId"
            label={'Kewarganegaraan'}
            options={data.selectionOptions.nationalityLookup}
        ...
        <CustomSelectField
            bind:errors={$addNextOfKinErrors.genderId}
            id="genderId"
            label={'Jantina'}
            options={data.selectionOptions.genderLookup}
        ...
        <CustomTextField
            placeholder="-"
            isRequired={false}
            bind:errors={$addNextOfKinErrors.workAddress}
            id="workAddress"
            label={'Alamat Majikan'}
            type="text"
        ...
        <CustomTextField
            placeholder="-"
            isRequired={false}
            bind:errors={$addNextOfKinErrors.workPostcode}
            id="workPostcode"
            label={'Poskod Majikan'}
            type="text"
        ...
        <CustomTextField
            placeholder="-"
            bind:errors={$addNextOfKinErrors.phoneNumber}
            id="phoneNumber"
            label={'Nombor Telefon'}
            type="text"
        ...
        <CustomSelectField
            bind:errors={$addNextOfKinErrors.maritalId}
            id="maritalId"
            label={'Status Perkahwinan'}
            options={data.selectionOptions.maritalLookup}
        ...
        {#if $addNextOfKinModal.maritalId === 3}
            <CustomTextField
                ...
                isRequired={false}
                type="date"
                bind:errors={$addNextOfKinErrors.marriageDate}
                id="marriageDate"
                label={'Tarikh Kahwin'}
