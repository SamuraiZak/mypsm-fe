...
import type { DocumentBase64RequestDTO } from "$lib/dto/core/common/base-64-document-request.dto.js";
...
export function _fileToBase64Object(file: File, type: number): Promise<string | DocumentBase64RequestDTO>{
