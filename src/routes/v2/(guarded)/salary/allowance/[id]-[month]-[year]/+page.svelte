                ...
                >
                    ...
                    >
                        <CustomTextField
                            ...
                            disabled
                            isRequired={false}
                            val={data.employeeDetail.employeeNo}
                        />
                        <CustomTextField
                            label="Nama"
                            id="name"
                        ...
                        <CustomTextField
                            ...
                            disabled
                            isRequired={false}
                            val={data.employeeDetail.identityCard}
                        />
                        <CustomTextField
                            label="Gred"
                            id="grade"
                        ...
                        <CustomTextField
                            ...
                            disabled
                            isRequired={false}
                            val={data.employeeDetail.currentPlacement}
                        />
                        <CustomTextField
                            label="Kumpulan"
                            id="group"
                        ...
                        <CustomTextField
                            ...
                            disabled
                            isRequired={false}
                            val={data.employeeDetail.status}
                        />
                    </div>
                </div>
            </StepperContentBody>
                ...
                >
                    ...
                    >
                        <CustomTextField
                            ...
                            isRequired={false}
                            placeholder=""
                            val={data.salaryDetail?.salaryLevel}
                        />
                        <CustomTextField
                            label="Gaji Pokok (RM)"
                            id="baseSalary"
                            ...
                            isRequired={false}
                            placeholder=""
                           val={data.salaryDetail?.baseSalary}
                        />
                        <CustomTextField
                            label="ITKA"
                            id="itka"
                        ...
                        <CustomTextField
                            ...
                            isRequired={false}
                            placeholder=""
                            val={data.salaryDetail?.salaryMovementTotal}
                        />
                    </div>
                    </div>
                </div>
