<script lang="ts">
    import { AllowanceCeremonyClothingSchema } from '$lib/schemas/mypsm/allowance/allowance.schema';
    ...
    <Stepper activeIndex={1}>
        ...
        <StepperContent>
            <StepperContentHeader title="Butiran Permohonan">
                <TextIconButton
                    onClick={() => {
                        $ceremonyClothingForm.isDraft = true;
                    }}
                    form={activeFormId}
                    type="draft"
                    label="Simpan"
                ...
                <div class="flex w-full flex-col items-start justify-start p-4">
                    ...
                    {#if activeFormId == 'ceremonyClothingForm'}
                        <form
                            ...
                            class="flex w-full flex-col items-start justify-start gap-2 divide-y lg:w-1/2 min-w-[500px]"
                        >
                            <div
