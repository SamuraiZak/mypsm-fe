<script lang="ts">
    ...
    let title: string = "Skala Penilaian Pengetahuan, Kemahiran dan Penghasilan Kerja"
    let totalVal: number;
    let eachVal: number[] = [];
    let totalLabel: string = "Jumlah Markah Aspek A ( /50)"
    $: {
...
<div class="flex h-full max-h-full w-full flex-col gap-10 rounded-md">
        ...
        <thead class="sticky top-0 z-[1]">
            ...
            >
                {#each columnLabel as col}
                    <th
                        colSpan={2}
                        class="h-full w-10 border-r border-t border-ios-labelColors-separator-light px-2.5"
                    >
                        <div
                            class="flex h-full flex-row items-center justify-center"
                        >
    ...
    <div class="flex w-full flex-col items-center justify-center">
        ...
        <div class="item-start flex w-full flex-row justify-start gap-5">
            <span
                class="select-none align-middle text-lg font-medium text-ios-labelColors-secondaryLabel-light"
                >{totalLabel} :</span
            >
            <span
                class="select-none align-middle text-lg font-medium text-ios-labelColors-secondaryLabel-light"
