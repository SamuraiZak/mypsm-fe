...
<section>
    ...
    >
        ...
        <DateSelector handleDateChange label="Tarikh Dijangka Bersalin (EDD)"></DateSelector>
    </div>
    <div class="flex max-h-full w-full flex-col items-start justify-start">
        <LongTextField
            ...
            placeholder="Sila taip jawapan anda dalam ruangan ini"
        ></LongTextField>
        <SectionHeader title="Cuti Bersalin Pegawai yang telah diambil dalam tahun semasa"></SectionHeader>
        <DynamicTable
            tableItems={tarikh}
        ></DynamicTable>
    </div>
