<script lang="ts">
    ...
    import CutiTanpaRekod from '../../../../pelulus/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiTanpaRekod.svelte';
    import CutiSeparuhGaji from '../../../../pelulus/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiSeparuhGaji.svelte';
    import CutiTanpaGaji from '../../../../pelulus/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiTanpaGaji.svelte';
    import CutiBersalinAwal from '../../../../pelulus/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiBersalinAwal.svelte';
    import CutiBersalinPegawai from '../../../../pelulus/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiBersalinPegawai.svelte';
    import CutiIsteriBersalin from '../../../../pelulus/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiIsteriBersalin.svelte';
    import CutiHaji from '../../../../pelulus/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiHaji.svelte';
    import CutiKuarantin from '../../../../pelulus/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiKuarantin.svelte';
    import CutiMenjagaAnakTanpaGaji from '../../../../pelulus/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiMenjagaAnakTanpaGaji.svelte';
    import CutiKursusSambilan from '../../../../pelulus/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiKursusSambilan.svelte';
    import CutiPerakuanTidakHadirKePejabat from '../../../../pelulus/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiPerakuanTidakHadirKePejabat.svelte';
    import CutiSakitLanjutan from '../../../../pelulus/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiSakitLanjutan.svelte';
    import CutiTanpaGajiMengikutPasangan from '../../../../pelulus/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiTanpaGajiMengikutPasangan.svelte';
