        ...
        <TabContent title="Permohonan Sendiri">
            ...
            <div class="w-full">
                <DynamicTable
                    ...
                    detailActions={() => {
                        goto(
                            '/pelulus/perjawatan/pertukaran/permohonan-sendiri/butiran',
                        );
                    }}
                />
            </div>
        ...
        <TabContent title="Arahan Pengarah Bahagian/Negeri">
            ...
            <div class="w-full">
                <DynamicTable
                    ...
                    detailActions={() => {
                        goto(
                            '/pelulus/perjawatan/pertukaran/arahan-pengarah/butiran',
                        );
                    }}
                />
            </div>
        ...
        <TabContent title="Arahan Pihak Pengurusan">
            ...
            <div class="w-full">
                <DynamicTable
                    ...
                    detailActions={() => {
                        goto(
                            '/pelulus/perjawatan/pertukaran/arahan-pengurusan/butiran',
                        );
                    }}
                />
            </div>
