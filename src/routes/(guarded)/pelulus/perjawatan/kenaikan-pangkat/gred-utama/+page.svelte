...
<section class="flex w-full flex-col items-start justify-start">
    <ContentHeader
        title="Kenaikan Pangkat Gred Utama"
        description="Hal-hal berkaitan Kenaikan Pangkat untuk Gred Utama"
    >
        <FormButton
            type="close"
            onClick={() => {
            ...
            >
                        ...
                        tableItems={mockPromotionCandidateDetail.filter(
                            (record) =>
                                record.secretariatConfirmation !=
                                    'Sedang Diproses' &&
                                record.supporterSupport != 'Sedang Diproses',
                        )}
                        withActions
                ...
                {:else}
                    ...
                    <LongTextField
                        ...
                        value="Diluluskan untuk dinaikan pangkat."
                        {disabled}
                    ></LongTextField>
                    <p class="h-[35px] text-sm text-system-primary">
        ...
        <StepperContentBody>
            ...
            >
                {#if detailsPromotionInfo == false}
                    ...
                    ></TextField>
                    <p class="h-[35px] text-sm text-system-primary">Pelulus</p>
                    <TextField label="Keputusan" value="LULUS" disabled
                    ></TextField>
                    <LongTextField
                        label="Ulasan / Tindakan"
                        value="Diluluskan untuk dinaikan pangkat."
