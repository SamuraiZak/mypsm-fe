<script lang="ts">
    ...
    import { tuntutanKlinikPanel } from '$lib/mocks/pelulus/perubatan/tuntutan-klinik-panel';
...
>
    <FilterContainer>
        <div class="flex flex-row gap-x-2.5">
            <div class="flex flex-row items-center justify-center gap-x-2.5">
                ...
                <p class="text-sm font-normal">Bulan</p>
                ...
                <p class="text-sm font-normal">Negeri</p>
                <div class="flex flex-row items-center justify-start gap-x-2.5">
                    <Select
                        id="bulan"
                        items={[
    ...
    <section class="h-full w-full">
        ...
        <DynamicTable
            tableItems={tuntutanKlinikPanel}
            withActions
            actionOptions={['detail']}
            detailActions={() => {
                goto(
                    '/pelulus/perubatan/bil-tuntutan-klinik/maklumat-bil-tuntutan-klinik-panel',
                );
            }}
        ></DynamicTable>
    </section>
