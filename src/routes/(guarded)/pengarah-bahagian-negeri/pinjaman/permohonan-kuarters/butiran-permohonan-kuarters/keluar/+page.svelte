<script lang="ts">
    ...
    const rentalRate: RadioOption[] = [
        {
            value: 'Simpan Balik Kes Kepada JKTT untuk Dipertimbangkan Semula',
            label: 'Simpan Balik Kes Kepada JKTT untuk Dipertimbangkan Semula',
        },
        {
        ...
        {
            value: 'Mengakas dan Membebaskan',
            label: 'Mengakas dan Membebaskan',
        },
    ];
...
<section class="flex w-full flex-col items-start justify-start">
    <ContentHeader
        title="Semak Maklumat Permohonan Keluar Kuarter K234312"
...
<Stepper>
    <StepperContent>
        ...
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                ...
                >
                    <RadioSingle {disabled} legend="Jenis Pemohon" {options}
                    ></RadioSingle>
                </div>
    ...
    <StepperContent>
        ...
        >
            <TextIconButton primary label="Simpan" form="quarterRentalRateForm">
