<script lang="ts">
    ...
    import { pengesahanLantikanGred } from '$lib/mocks/pengarah-integriti/perjawatan/pengesahan/pengesahan-lantikan-gred';
    import { pengesahanLantikanBaru } from '$lib/mocks/pengarah-integriti/perjawatan/pengesahan/pengesahan-lantikan-baru';
    ...
    <CustomTab>
        <CustomTabContent title="Pengesahan Lantikan Baru">
            ...
            >
                <DynamicTable
                    hasCheckbox
                    tableItems={pengesahanLantikanBaru}
                    withActions
                    actionOptions={['detail']}
                    detailActions={() => {
                        goto(
                            '/pengarah-integriti/perjawatan/pengesahan-dalam-perkhidmatan/pengesahan-lantikan-baru',
                        );
                    }}
                    bind:passData
                ></DynamicTable>
        ...
        >
            ...
            >
                <DynamicTable
                    hasCheckbox
                    tableItems={pengesahanLantikanGred}
                    withActions
                    actionOptions={['detail']}
                    detailActions={() => {
                        goto(
                            '/pengarah-integriti/perjawatan/pengesahan-dalam-perkhidmatan/pengesahan-lantikan-gred',
                        );
                    }}
                    bind:passData
                ></DynamicTable>
