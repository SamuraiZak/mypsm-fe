...
<section class="flex w-full flex-col items-start justify-start">
    <ContentHeader
        ...
        ><FormButton
            type="close"
            onClick={() => {
                goto('/pengarah-integriti/perjawatan/pengesahan-dalam-perkhidmatan');
            }}
        /></ContentHeader
    >
</section>
    ...
    <StepperContent>
        ...
        <StepperContentBody
            ...
            >
                ...
                ></LongTextField>
                <RadioSingle options={sahOptions} />
            </div>
            <div class="flex w-full flex-col gap-2">
                <p class="text-sm font-bold">
            ...
            <div class="flex w-full flex-col gap-2">
                ...
                >
                    ...
                    <p
                        class="mt-2 h-fit w-full bg-bgr-primary text-sm italic text-system-accent"
                    >
                        ● Menunggu keputusan daripada Pengarah Integriti
                    </p>
                </div>
            </div>
            <div class="flex w-full flex-col gap-2">
