...
<section class="flex w-full flex-col items-start justify-start">
    <ContentHeader
        ...
        ><TextIconButton
            ...
            label="Tambah Rekod"
            onClick={() => {
                goto('maklumat-bil-rawatan/tambah-rekod');
        ...
        <section class="h-full w-full">
            <DataTable>
                <DtTableHead>
                    ...
                    <DtTableHeadCell title="Kod Klinik"></DtTableHeadCell>
                    <DtTableHeadCell title="Nama Klinik"></DtTableHeadCell>
                ...
                <DtTableBody>
                    {#each maklumatBilRawatan as item}
                        <DtTableRow>
                            ...
                            ></DtTableDataCell>
                            <DtTableDataCell value={item.namaKlinik}
                            ></DtTableDataCell>
