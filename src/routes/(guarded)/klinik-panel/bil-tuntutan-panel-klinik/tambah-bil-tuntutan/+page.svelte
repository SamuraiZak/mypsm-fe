...
<Stepper>
    <StepperContent>
        <StepperContentHeader title="Maklumat Invois"></StepperContentHeader>
        <StepperContentBody>
            <div class="flex w-full flex-col gap-2">
                ...
                ></TextField>
                <DropdownSelect
                    id="bulanRawatanDropdown"
                    label="Bulan Rawatan"
                    dropdownType="label-left-full"
                    bind:index={selectedBulanRawatan}
                    options={bulanRawatan}
                ></DropdownSelect>
                <DropdownSelect
                    id="tahunRawatanDropdown"
                    label="Tahun Rawatan"
                    dropdownType="label-left-full"
                    bind:index={selectedTahunRawatan}
                    options={tahunRawatan}
                ></DropdownSelect>
                <TextField
                    {disabled}
                    id="jumlah"
    ...
    <StepperContent>
        ...
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                ...
                >
                    <SectionHeader title="Muat Naik Dokumen"
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                Seret dan lepas fail anda ke dalam ruangan ini atau pilih fail dari peranti anda
                            </p>
                            <div
                ...
                <div class="flex w-full flex-col gap-2">
                    ...
                    >
                        <li>
                            <DownloadAttachment fileName="Dokumen Sokongan-1" />
                        </li>
                        <li>
                            <DownloadAttachment fileName="Dokumen Sokongan-2" />
                        </li>
                    </ul>
                </div>
            </div></StepperContentBody
