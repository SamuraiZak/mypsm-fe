...
<section>
    ...
    >
        <SectionHeader title="Cuti Tanpa Gaji"><TextIconButton
            primary
    ...
    <div class="flex max-h-full w-full flex-col items-start justify-start">
        <SectionHeader title="Cuti Tanpa Gaji yang telah diambil dalam tahun semasa"></SectionHeader>
        <DynamicTable
            tableItems={ctr}
        ></DynamicTable>
    </div>
