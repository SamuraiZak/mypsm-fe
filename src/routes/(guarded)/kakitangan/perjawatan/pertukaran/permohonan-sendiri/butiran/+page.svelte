...
<Stepper dataId={id} dataStatus={status}>
        ...
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                <div class="flex w-full flex-row text-sm">
                    <div class="w-1/4"><span class="font-semibold">Alasan Pertukaran</span></div>
                    <div class="w-3/4">
    ...
    <StepperContent>
        ...
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                <SectionHeader title="Sila sahkan permohonan anda sebelum hantar"></SectionHeader>
        ...
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                <SectionHeader
                    ...
                    title="Pilihan Penempatan Pertama"
                ></SectionHeader>
                <SectionHeader
                ...
                <SectionHeader
                    color="system-primary"
                    title="Pilihan Penempatan Kedua"
                ></SectionHeader>
                <SectionHeader
                    title="Ulasan Keputusan daripada Pengarah Bahagian/Negeri"
                ></SectionHeader>
                ...
                <div class="flex w-full flex-row text-sm">
                    <label for="" class="w-[220px]">Keputusan</label><Badge
                        border
                        color="red">TIDAK DISOKONG</Badge
                    >
                </div>
                <SectionHeader title="Butiran Tindakan Tatatertib (jika ada)"
                ></SectionHeader>
                <TextField
                    label="Jenis Hukuman"
    ...
    <StepperContent>
        ...
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                <RadioSingle
                    {options}
                    legend="Adakah anda perlu penangguhan pertukaran?"
                    disabled={false}
                ></RadioSingle>
            </div></StepperContentBody
        >
    ...
    <StepperContent>
        ...
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                ...
                />
                <SectionHeader title="Keputusan Permohonan Penangguhan/Pindaan Penempatan"></SectionHeader>
                <TextField
                    label="Keputusan"
                    value="Sedang Diproses"
                    disabled={true}
    ...
    <StepperContent>
        <StepperContentHeader title="Muat Turun Dokumen Lapor Diri"
        ></StepperContentHeader>
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                <SectionHeader
                    title="Sila cetak dan isi borang-borang berikut untuk dibawa semasa
                melapor diri"
                ></SectionHeader>
                <DownloadAttachment
                    label="Surat Pertukaran Penempatan"
                    fileName="Surat Pertukaran Penempatan.pdf"
                />
                <DownloadAttachment
                    label="Nota Serah Tugas"
                    fileName="Nota Serah Tugas.pdf"
                />
                <DownloadAttachment
                    label="Borang Lapor Diri"
                    fileName="Borang_Lapor_Diri.pdf"
                />
                <SectionHeader title="Ulasan Keputusan daripada Peranan Lain"
                ></SectionHeader>
                ...
                ></SectionHeader>
                <TextField label="Nama" value="Sufian Aadam" disabled={true}
                ></TextField>
                <LongTextField
                    label="Ulasan/Tindakan"
    ...
    <StepperContent>
        ...
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                <SectionHeader title="Keputusan Permohonan Pertukaran"></SectionHeader>
                <TextField label="Keputusan" value="Lulus" disabled={true}
                ></TextField>
            </div></StepperContentBody
        >
    </StepperContent>
