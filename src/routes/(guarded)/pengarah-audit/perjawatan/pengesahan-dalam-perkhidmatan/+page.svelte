        ...
        <CustomTabContent title="Pengesahan Lantikan Baru">
            ...
            >
                <DynamicTable
                    ...
                    detailActions={() => {
                        goto(
                            '/pengarah-audit/perjawatan/pengesahan-dalam-perkhidmatan/pengesahan-lantikan-baru',
                        );
                    }}
                    bind:passData
                ></DynamicTable>
        ...
        >
            ...
            >
                <DynamicTable
                    ...
                    detailActions={() => {
                        goto(
                            '/pengarah-audit/perjawatan/pengesahan-dalam-perkhidmatan/pengesahan-lantikan-gred',
                        );
                    }}
                    bind:passData
                ></DynamicTable>
