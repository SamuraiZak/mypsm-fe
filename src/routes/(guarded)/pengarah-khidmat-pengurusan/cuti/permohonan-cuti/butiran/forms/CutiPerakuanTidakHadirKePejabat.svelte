...
<section>
    ...
    >
        <SectionHeader title="Cuti Perakuan Tidak Hadir ke Pejabat"></SectionHeader>
        <div
    ...
    <div class="flex max-h-full w-full flex-col items-start justify-start">
        <SectionHeader
            title="Cuti Perakuan Tidak Hadir ke Pejabat yang telah diambil sepanjang perkhidmatan"
        ></SectionHeader>
