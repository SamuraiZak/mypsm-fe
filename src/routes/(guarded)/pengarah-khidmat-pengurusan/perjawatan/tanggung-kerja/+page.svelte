<script lang="ts">
    ...
    import { permohonanTanggungKerja } from '$lib/mocks/pengarah-khidmat-pengurusan/tanggung-kerja/permohonan-tanggung-kerja';
...
>
    ...
    <div class="flex max-h-full w-full flex-col items-start justify-start">
        <DynamicTable
            ...
            detailActions={() => {
                goto(
                    '/pengarah-khidmat-pengurusan/perjawatan/tanggung-kerja/permohonan/butiran',
                );
            }}
        ></DynamicTable>
    </div>
