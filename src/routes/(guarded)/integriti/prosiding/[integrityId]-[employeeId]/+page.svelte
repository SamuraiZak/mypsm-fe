<script lang="ts">
    ...
    $: {
        ...
        data.view.proceedingTypeChargeDetailView.confirmation.status === true
            ...
            <StepperContent>
                ...
                <StepperContentBody>
                    ...
                    >
                        ...
                        ></CustomTextField>
                        {$chargesListForm.accusationList[2].accusationName}
                        {$sentencingMeetingForm.meetingResult[2].result}
