<script lang="ts">
    ...
    import CutiGantian from '../../../../penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiGantian.svelte';
    import CutiTanpaRekod from '../../../../penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiTanpaRekod.svelte';
    import CutiSeparuhGaji from '../../../../penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiSeparuhGaji.svelte';
    import CutiTanpaGaji from '../../../../penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiTanpaGaji.svelte';
    import CutiBersalinAwal from '../../../../penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiBersalinAwal.svelte';
    import CutiBersalinPegawai from '../../../../penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiBersalinPegawai.svelte';
    import CutiIsteriBersalin from '../../../../penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiIsteriBersalin.svelte';
    import CutiHaji from '../../../../penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiHaji.svelte';
    import CutiKuarantin from '../../../../penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiKuarantin.svelte';
    import CutiMenjagaAnakTanpaGaji from '../../../../penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiMenjagaAnakTanpaGaji.svelte';
    import CutiKursusSambilan from '../../../../penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiKursusSambilan.svelte';
    import CutiPerakuanTidakHadirKePejabat from '../../../../penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiPerakuanTidakHadirKePejabat.svelte';
    import CutiSakitLanjutan from '../../../../penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiSakitLanjutan.svelte';
    import CutiTanpaGajiMengikutPasangan from '../../../../penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiTanpaGajiMengikutPasangan.svelte';
    import CutiPenyakitBarahDanKusta from '../../../../penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiPenyakitBarahDanKusta.svelte';
    import CutiPenyakitTibi from '../../../../penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod/forms/CutiPenyakitTibi.svelte';
    ...
    import { uploadedFileSchema } from '../butiran-cuti-gantian/form-schema';
