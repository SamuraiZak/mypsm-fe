...
>
    <CustomTab>
        <CustomTabContent title="Cuti Gantian">
            <FilterContainer>
                <StaffSelector />
            ...
            >
                <DynamicTable
                    ...
                    detailActions={() => {
                        goto(
                            '/penyokong/cuti/permohonan-cuti/butiran-cuti-gantian',
                        );
                    }}
                ></DynamicTable>
            </div>
        </CustomTabContent>
        <CustomTabContent title="Cuti Tanpa Rekod">
            <FilterContainer>
                <StaffSelector />
                <div class="flex flex-row gap-x-2.5">
                    <div
            ...
            >
                <DynamicTable
                    ...
                    detailActions={() => {
                        goto(
                            '/penyokong/cuti/permohonan-cuti/butiran-cuti-tanpa-rekod',
                        );
                    }}
                ></DynamicTable>
            </div>
