<script lang="ts">
    ...
    import { persaraanSenaraiKakitangan } from '$lib/mocks/penyokong/persaraan-senarai-kakitangan';
...
>
    ...
    >
            ...
            >
                <DynamicTable
                    tableItems={persaraanSenaraiKakitangan}
                    withActions
                    actionOptions={['detail']}
                    detailActions={() => {
                        goto(
                            '/penyokong/perjawatan/persaraan/butiran-persaraan',
                        );
                    }}
                ></DynamicTable>
            </div>
