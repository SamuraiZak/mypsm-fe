        ...
        <CustomTabContent title="Gred 1-54">
            ...
            >
                <DynamicTable
                    ...
                    editActions={() => {
                        goto(
                            '/penyokong/perjawatan/kenaikan-pangkat/gred-1_54',
                        );
                    }}
                    detailActions={() => {
                        // goto(
                        //     '/penyokong/perjawatan/kenaikan-pangkat/gred-1_54/butiran',
                        // );
                    }}
                ></DynamicTable>
            </div>
        ...
        <CustomTabContent title="TBK 1 dan 2 - Kumpulan Sokongan">
            ...
            >
                <DynamicTable
                    ...
                    actionOptions={['detail', 'edit']}
                    editActions={() => {
                        goto('/penyokong/perjawatan/kenaikan-pangkat/tbk-1-2');
                    }}
                    detailActions={() => {
                        // goto(
                        //     '/penyokong/perjawatan/kenaikan-pangkat/gred-1_54/butiran',
        ...
        <CustomTabContent title="Gred Utama">
            ...
            >
                <DynamicTable
                    ...
                    editActions={() => {
                        goto(
                            '/penyokong/perjawatan/kenaikan-pangkat/gred-utama',
                        );
                    }}
                    detailActions={() => {
                        // goto(
