        ...
        <TabContent title="Permohonan Sendiri">
            ...
            <div class="w-full">
                <DynamicTable
                    ...
                    detailActions={() => {
                        goto(
                            '/penyokong/perjawatan/pertukaran/permohonan-sendiri/butiran',
                        );
                    }}
                />
            </div>
        ...
        <TabContent title="Arahan Pengarah Bahagian/Negeri">
            ...
            <div class="w-full">
                <DynamicTable
                    ...
                    detailActions={() => {
                        goto(
                            '/penyokong/perjawatan/pertukaran/arahan-pengarah/butiran',
                        );
                    }}
                />
            </div>
        </TabContent>
        <TabContent title="Arahan Pihak Pengurusan">
            <SectionHeader title="Senarai Rekod Permohonan Pertukaran"
            ></SectionHeader>
            <div class="w-full">
                <DynamicTable
                    ...
                    detailActions={() => {
                        goto(
                            '/penyokong/perjawatan/pertukaran/arahan-pengurusan/butiran',
                        );
                    }}
                />
            </div>
