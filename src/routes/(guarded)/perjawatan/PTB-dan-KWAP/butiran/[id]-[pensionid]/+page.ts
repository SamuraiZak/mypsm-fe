...
import type { ApproveDetailDTO, AssignRolesRelatedDTO, PensionDetailDTO, PersonalDetailDTO, RolesRelatedDTO, SupportDetailDTO } from "$lib/dto/mypsm/employment/ptb-dan-kwap/ptb-kwap-dto";
