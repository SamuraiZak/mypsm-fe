<script lang="ts">
    ...
    $: {
        if (data.view.newOfferDetailView.meetingResult.isReadonly) {
        ...
        if (data.view.newOfferDetailView.supporter.isReadonly) {
        ...
        if (data.view.newOfferDetailView.approver.isReadonly) {
...
<ContentHeader title="Maklumat Prosiding Tatatertib">
    {#if $isReadOnlyNewOfferApprovalResult && $newOfferApproverIsApproved}
        <Badge color="dark">Proses Tawaran Baru Sah</Badge>
    {/if}
    {#if ($isReadOnlyNewOfferSupporterResult && !$newOfferSupporterIsApproved) || ($isReadOnlyNewOfferApprovalResult && !newOfferApproverIsApproved)}
        <Badge color="red">Proses Tawaran Baru Tidak Sah</Badge>
    {/if}
...
<Stepper>
                ...
                {#each $newOfferMeetingDetailForm.employees as _, index}
                    ...
                    >
                        ...
                        <CustomSelectField
                            ...
                            placeholder="-"
                            options={data.lookups.generalMeetingLookup}
                            bind:val={$newOfferMeetingDetailForm.employees[
                                index
                            ].status}
                        ></CustomSelectField>
                        ...
                        >
                            ...
                            >
                                ...
                                <CustomSelectField
                                    ...
                                    options={data.lookups.serviceTypeLookup}
                                    bind:val={$newOfferServiceDetailForm
                                        .employees[index].employmentStatusId}
                                ></CustomSelectField>
                                ...
                                <CustomTextField
                                    ...
                                    placeholder="-"
                                    bind:val={$newOfferServiceDetailForm
                                        .employees[index].eligibleLeaveCount}
                                ></CustomTextField>
                                ...
                                <CustomTextField
                                    ...
                                    placeholder="-"
                                    bind:val={$newOfferServiceDetailForm
                                        .employees[index].firstEffectiveDate}
                                ></CustomTextField>
                                ...
                                <CustomTextField
                                    ...
                                    placeholder="-"
                                    bind:val={$newOfferServiceDetailForm
                                        .employees[index].civilServiceStartDate}
                                ></CustomTextField>
                                ...
                                <CustomTextField
                                    ...
                                    placeholder="-"
                                    bind:val={$newOfferServiceDetailForm
                                        .employees[index].firstServiceDate}
                                ></CustomTextField>
                                ...
                                <CustomTextField
                                    ...
                                    placeholder="-"
                                    bind:val={$newOfferServiceDetailForm
                                        .employees[index].retirementDate}
                                ></CustomTextField>
                                ...
                                <CustomSelectField
                                    ...
                                    bind:val={$newOfferServiceDetailForm
                                        .employees[index].retirementBenefit}
                                ></CustomSelectField>
    ...
    <StepperContent>
        ...
        >
            {#if !$isReadOnlyNewOfferSupporterResult && data.roles.isSupporterRole}
                <TextIconButton
                    type="primary"
                    label="Simpan"
                    form="integrityDirectorDetailForm"
                ></TextIconButton>
            {:else if !$isReadOnlyNewOfferApprovalResult && data.roles.isApproverRole}
                <TextIconButton
                    type="primary"
                    label="Simpan"
                    form="integrityDirectorDetailForm"
            ...
            <div class="flex w-full flex-col gap-2.5">
                {#if !$isReadOnlyNewOfferSupporterResult && data.roles.isSupporterRole}
                    ...
                    >
                        ...
                        <CustomTextField
                            disabled={$isReadOnlyNewOfferSupporterResult}
                ...
                {:else if !$isReadOnlyNewOfferApprovalResult && data.roles.isApproverRole}
                    ...
                    >
                        ...
                        <CustomTextField
                            disabled={$isReadOnlyNewOfferApprovalResult}
