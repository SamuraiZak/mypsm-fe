...
<script lang="ts">
    ...
    function handleDateChange(event: any) {
        selectedDate = new Date(event.target.val);
...
<Stepper dataId={id} dataStatus={status}>
    ...
    <StepperContent>
        ...
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                <CustomTextField id="name" label="Nama" val="Mohd Irfan bin Abu"
                ></CustomTextField>
                <CustomTextField id="noKP" label="No. K/P" val="890210-11-2667"
                ></CustomTextField>
                <CustomTextField
                    id="phoneNumber"
                    label="No. Telefon"
        ...
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                <CustomTextField
                    ...
                    val="Kerani"
                ></CustomTextField>
                <CustomTextField id="Gred" label="Gred" val="M22"
                ></CustomTextField>
                <CustomTextField
                    id="tarikhLantikan"
    ...
    <StepperContent>
        ...
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                ...
                />
                <CustomTextField id="tarikh" label="Tarikh" val="13/08/2023"
                ></CustomTextField>
            </div></StepperContentBody
        >
    </StepperContent>
