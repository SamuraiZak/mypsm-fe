<script lang="ts">
    ...
    import {
        RetirementEndorsementSchema,
        RetirementEndorserDetailSchema,
        RetirementVoluntaryDetailSchema,
    } from '$lib/schemas/mypsm/employment/retirement/retirement.schema';
    ...
    import {
        _applicationDetailFormSubmit,
        _approvalFormSubmit,
        _certificationFormSubmit,
        _confirmationFormSubmit,
        _documentCertificationFormSubmit,
        _firstSupporterFormSubmit,
        _letterCertificationFormSubmit,
        _secondSupporterFormSubmit,
    ...
    const {
        ...
        async onSubmit(input) {
            const response = _applicationDetailFormSubmit(
    ...
    const {
        ...
        validators: zodClient(RetirementEndorsementSchema),
        async onSubmit(input) {
            $firstSupporterForm.voluntaryId = Number(data.params.id);
    ...
    const {
        ...
        validators: zodClient(RetirementEndorsementSchema),
        async onSubmit(input) {
            $secondSupporterForm.voluntaryId = Number(data.params.id);
            _secondSupporterFormSubmit($secondSupporterForm);
        },
    });
    ...
    const {
        ...
        validators: zodClient(RetirementEndorsementSchema),
        async onSubmit(input) {
            $approvalForm.voluntaryId = Number(data.params.id);
            _approvalFormSubmit($approvalForm);
        },
    });
    const {
        ...
        validators: zodClient(RetirementEndorsementSchema),
        async onSubmit(input) {
            $secretaryApprovalForm.voluntaryId = Number(data.params.id);
            _secretaryApprovalFormSubmit(
    ...
    const {
        ...
        validators: zodClient(RetirementEndorsementSchema),
        async onSubmit(input) {
            $documentCertificationForm.voluntaryId = Number(data.params.id);
             _documentCertificationFormSubmit(
    ...
    const {
        ...
        validators: zodClient(RetirementEndorsementSchema),
        async onSubmit(input) {
            $letterCertificationForm.voluntaryId = Number(data.params.id);
             _letterCertificationFormSubmit(
    ...
    <Stepper>
            ...
            <StepperContentBody>
                ...
                >
                    ...
                    >
                        ...
                        <div class="flex w-full flex-col gap-2">
                            <CustomTextField
                                disabled={data.props.currentApplicationDetail
        ...
        <StepperContent>
            <StepperContentHeader title="Perakuan Dari Unit Integriti">
                {#if data.props.currentApplicationDetail.applicationDetail !== null && data.props.currentApplicationDetail.certification === null && data.props.currentRoleCode === UserRoleConstant.unitIntegriti.code}
                    <TextIconButton
                        label="Hantar"
                        icon="check"
                        form="certificationForm"
        ...
        <StepperContent>
            <StepperContentHeader title="Pengesahan Permohonan Persaraan">
                {#if data.props.currentApplicationDetail.certification !== null && data.props.currentApplicationDetail.confirmation === null && data.props.currentRoleCode === UserRoleConstant.urusSetiaPersaraan.code}
                    <TextIconButton
                        label="Hantar"
                        icon="check"
                        form="confirmationForm"
        ...
        {#if data.props.currentApplicationDetail.confirmation !== null}
            <StepperContent>
                <StepperContentHeader title="Penyokong & Pelulus">
                    {#if data.props.currentApplicationDetail.supportApprover === null && data.props.currentRoleCode === UserRoleConstant.urusSetiaPersaraan.code}
                        <TextIconButton
                            label="Hantar"
                            icon="check"
                            form="supportApproverForm"
            ...
            <!-- FIRST SUPPORTER -->
            <!-- =============================== -->
            {#if data.props.currentApplicationDetail.supportApprover !== null}
                <StepperContent>
                    <StepperContentHeader title="Penyokong #1">
                        {#if data.props.currentApplicationDetail.firstSupporter === null && data.props.currentRoleCode === UserRoleConstant.penyokong.code}
                            <TextIconButton
                                label="Hantar"
                                icon="check"
                                form="firstSupporterForm"
            ...
            <!-- SECOND SUPPORTER -->
            <!-- =============================== -->
            {#if data.props.currentApplicationDetail.firstSupporter !== null}
                <StepperContent>
                    <StepperContentHeader title="Penyokong #2">
                        {#if data.props.currentApplicationDetail.secondSupporter === null && data.props.currentRoleCode === UserRoleConstant.penyokong.code}
                            <TextIconButton
                                label="Hantar"
                                icon="check"
                                form="secondSupporterForm"
            ...
            <!-- APPROVAL -->
            <!-- =============================== -->
            {#if data.props.currentApplicationDetail.secondSupporter !== null}
                <StepperContent>
                    <StepperContentHeader
                        title="Kelulusan Permohonan Persaraan"
                    >
                        {#if data.props.currentApplicationDetail.approval === null && data.props.currentRoleCode === UserRoleConstant.pelulus.code}
                            <TextIconButton
                                label="Hantar"
                                icon="check"
                                form="approvalForm"
            ...
            {#if data.props.currentApplicationDetail.approval !== null}
                <StepperContent>
                    <StepperContentHeader title="Pengesahan Urus Setia">
                        {#if data.props.currentApplicationDetail.secretaryApproval === null && data.props.currentRoleCode === UserRoleConstant.urusSetiaPersaraan.code}
                            <TextIconButton
                                label="Hantar"
                                icon="check"
                                form="secretaryApprovalForm"
            ...
            <!-- =============================== -->
            {#if data.props.currentApplicationDetail.secretaryApproval !== null}
                <StepperContent>
                    <StepperContentHeader title="Pengesahan Dokumen Persaraan">
                        {#if data.props.currentApplicationDetail.documentCertification === null && data.props.currentRoleCode === UserRoleConstant.urusSetiaPersaraan.code}
                            <TextIconButton
                                label="Hantar"
                                icon="check"
                                form="documentCertificationForm"
            ...
            <!-- =============================== -->
            {#if data.props.currentApplicationDetail.documentCertification !== null}
                <StepperContent>
                    <StepperContentHeader title="Pengesahan Surat Persaraan">
                        {#if data.props.currentApplicationDetail.letterCertification === null && data.props.currentRoleCode === UserRoleConstant.urusSetiaPersaraan.code}
                            <TextIconButton
                                label="Hantar"
                                icon="check"
                                form="letterCertificationForm"
