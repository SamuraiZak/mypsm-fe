<script lang="ts">
    ...
    const proxyPromotionDate = dateProxy(updatePlacementMeetingResultForm, 'promotionDate', {
        format: 'date',
    });

    const proxyValidationDate = dateProxy(updateStaffPromotionForm, 'validationDate', {
        format: 'date',
    });
            ...
            {:else}
                ...
                >
                    <DateSelector
                        ...
                        handleDateChange
                        bind:selectedDate={$proxyValidationDate}
                        {disabled}
                    />
