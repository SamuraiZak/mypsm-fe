        ...
        <StepperContent>
            ...
            <StepperContentBody>
                ...
                >
                    ...
                    />
                    <RadioSingle legend="Keputusan" {options} />
                </div>
            </StepperContentBody>
        </StepperContent>
        <StepperContent>
        ...
        >
            ...
            <StepperContentBody>
                <div
                    class="flex h-fit w-full flex-col items-start justify-start gap-2"
                >
                <TextField label="Nama Penyokong" placeholder="-" value="Ismail Bin Ramdan" />
                <TextField label="Nama Pelulus" placeholder="-" value="Ramdan Bin Ismail" />
            </div>
            </StepperContentBody>
        </StepperContent>
    </Stepper>
