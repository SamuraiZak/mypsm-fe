<script lang="ts">
    ...
    import { tapisanTatatertib } from '$lib/mocks/urus-setia/pengesahan/melebihi-3-tahun/tapisan-tatatertib';
    ...
    const keputusanMesyuaratOptions: RadioOption[] = [
        {
            value: 'lulus',
            label: 'Lulus',
        },
...
<section class="flex w-full flex-col items-start justify-start">
    <ContentHeader
        title="Kemaskini Maklumat K1123"
        description="Maklumat-maklumat pengesahan bagi semua kakitangan K1123"
        ><FormButton
            type="close"
            onClick={() => {
                goto('/urus-setia/perjawatan/pengesahan-dalam-perkhidmatan');
            }}
        /></ContentHeader
    >
</section>
...
<Stepper>
    ...
    <StepperContent>
        <StepperContentHeader
            title="Keputusan Pengesahan Dalam Perkhidmatan Daripada Peranan - Peranan Berkaitan"
        ></StepperContentHeader>
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
