        ...
        <StepperContent>
            <StepperContentHeader title="Senarai Kakitangan Yang Terpilih">
                <TextIconButton
                    ...
                    onClick={() => {
                        goto(
                            '/urus-setia/perjawatan/pemangkuan/gred-1_54/baru',
                        );
                    }}
                >
                    ...
                    >
                        ...
                        {#if $meetingResultCandidateSelectionErrors.secretaryName}
                            <span
                                ...
                                >{$meetingResultCandidateSelectionErrors.secretaryName}</span
                            >
                        {/if}
                        ...
                        {#if $meetingResultCandidateSelectionErrors.directorName}
                            <span
                                class="ml-[220px] font-sans text-sm italic text-system-danger"
                                >{$meetingResultCandidateSelectionErrors.directorName}</span
                            >
                        {/if}
                    </form>
                </div>
            ...
            <StepperContentBody>
                ...
                >
                    ...
                    <DateSelector
                        ...
                        bind:selectedDate={$updateInterviewForm.meetingDate}
                    ></DateSelector>
                    ...
                    <DropdownSelect
                        hasError={!!$updateInterviewErrors.gred}
                        dropdownType={'label-left-full'}
                        name="gred"
                    ...
                    <DateSelector
                        ...
                        bind:selectedDate={$updateInterviewForm.interviewDate}
                    ></DateSelector>
                    ...
                    <DropdownSelect
                        hasError={!!$updateInterviewErrors.state}
                        dropdownType={'label-left-full'}
                        name="state"
                ...
                <StepperContentBody>
                    ...
                    >
                        ...
                        {#if $updateInterviewResultErrors.totalInterviewScore}
                            <span
                                class="ml-[220px] font-sans text-sm italic text-system-danger"
                                >{$updateInterviewResultErrors.totalInterviewScore}</span
                            >
                        {/if}
                    </form>
                ...
                <StepperContentBody>
                    ...
                    >
                        ...
                        {#if $promotionMeetingResultErrors.meetingName}
                            <span
                                class="ml-[220px] font-sans text-sm italic text-system-danger"
                                >{$promotionMeetingResultErrors.meetingName}</span
                            >
                        {/if}
                        ...
                        <DateSelector
                            ...
                            name="meetingDate"
                            label={'Tarikh Mesyuarat'}
                            bind:selectedDate={$promotionMeetingResultForm.meetingDate}
                        ></DateSelector>
                        {#if $promotionMeetingResultErrors.meetingDate}
                            <span
                                class="ml-[220px] font-sans text-sm italic text-system-danger"
                                >{$promotionMeetingResultErrors.meetingDate}</span
                            >
                        {/if}
                        ...
                        {#if $promotionMeetingResultErrors.meetingResult}
                            <span
                                class="ml-[220px] font-sans text-sm italic text-system-danger"
                                >{$promotionMeetingResultErrors.meetingResult}</span
                            >
                        {/if}
                        ...
                        {#if $promotionMeetingResultErrors.actingPosition}
                            <span
                                class="ml-[220px] font-sans text-sm italic text-system-danger"
                                >{$promotionMeetingResultErrors.actingPosition}</span
                            >
                        {/if}
                        ...
                        {#if $promotionMeetingResultErrors.actingGred}
                            <span
                                class="ml-[220px] font-sans text-sm italic text-system-danger"
                                >{$promotionMeetingResultErrors.actingGred}</span
                            >
                        {/if}
                    </form>
                    ...
                    >
                        ...
                        >
                            ...
                            {#if $promotionMeetingResultDetailErrors.meetingResultDropdown}
                                <span
                                    class="ml-[220px] font-sans text-sm italic text-system-danger"
                                    >{$promotionMeetingResultDetailErrors.meetingResultDropdown}</span
                                >
                            {/if}
                        </form>
                    </div>
                ...
                <StepperContentBody>
                    ...
                    >
                        ...
                        {#if $placementMeetingResultErrors.newPlacement}
                            <span
                                class="ml-[220px] font-sans text-sm italic text-system-danger"
                                >{$placementMeetingResultErrors.newPlacement}</span
                            >
                        {/if}
                        <div
                            class="flex max-h-full w-full flex-col items-start justify-start"
                        >
                            ...
                            {#if $placementMeetingResultErrors.newDirector}
                                <span
                                    class="ml-[220px] font-sans text-sm italic text-system-danger"
                                    >{$placementMeetingResultErrors.newDirector}</span
                                >
                            {/if}
                        </div>
                        <DateSelector
                        ...
                        {#if $placementMeetingResultErrors.reportingDate}
                            <span
                                class="ml-[220px] font-sans text-sm italic text-system-danger"
                                >{$placementMeetingResultErrors.reportingDate}</span
                            >
                        {/if}
                    </form>
                </StepperContentBody>
                    ...
                    >
                        ...
                        >
                            ...
                            />{#if $staffPlacementAmendmentErrors.placementAmendmentResult}
                                <span
                                    class="ml-[220px] font-sans text-sm italic text-system-danger"
                                    >{$staffPlacementAmendmentErrors.placementAmendmentResult}</span
                                >
                            {/if}
                        </div>
                        ...
                        {#if $staffPlacementAmendmentErrors.approvedNewReportingDate}
                            <span
                                class="ml-[220px] font-sans text-sm italic text-system-danger"
                                >{$staffPlacementAmendmentErrors.approvedNewReportingDate}</span
                            >
                        {/if}
                        ...
                        >
                            ...
                            {#if $staffPlacementAmendmentErrors.placementAmendmentApproval}
                                <span
                                    class="ml-[220px] font-sans text-sm italic text-system-danger"
                                    >{$staffPlacementAmendmentErrors.placementAmendmentApproval}</span
                                >
                            {/if}
                        </div>
                    </form>
                    ...
                    >
                        ...
                        >
                            ...
                            {#if $updateActingErrors.supporterName}
                                <span
                                    class="ml-[220px] font-sans text-sm italic text-system-danger"
                                    >{$updateActingErrors.supporterName}</span
                                >
                            {/if}
                        </div>
                        <div
