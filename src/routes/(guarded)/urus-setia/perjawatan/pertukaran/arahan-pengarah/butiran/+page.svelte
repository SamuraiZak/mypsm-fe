...
<Stepper dataId={id} dataStatus={status}>
    ...
    <StepperContent>
        ...
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                <TextField label="No. Pekerja" value="001023" disabled={true}
                ></TextField>
                <TextField
                    label="Nama"
                ...
                <TextField
                    ...
                    disabled={true}
                ></TextField>
                <TextField label="Program" value="-" disabled={true}
                ></TextField>
                <TextField label="Skim" value="-" disabled={true}></TextField>
                <TextField label="Gred" value="F41" disabled={true}></TextField>
                <TextField
                    label="Nama Jawatan"
        ...
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                ...
                <TextField
                    ...
                    value="Memenuhi keperluan tenaga kerja"
                    disabled={true}
                ></TextField>
            </div></StepperContentBody
        >
        ...
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                ...
                <DropdownField
                    ...
                    id="dropdown3"
                    options={[
                        { value: '1', name: 'LULUS/TIDAK LULUS' },
                        { value: '2', name: '1/12' },
                        { value: '3', name: '1/102' },
                        { value: '4', name: '2/101' },
                    ]}
                ...
                <DropdownField
                    dropdownType="label-left-full"
                    label="Tarikh Kuatkuasa Pertukaran (Jika Lulus)"
                    id="dropdown2"
                    options={[
                        { value: '1', name: 'DD/MM/YYYY' },
                        { value: '2', name: '1/12' },
    ...
    <StepperContent>
        <StepperContentHeader title="Penangguhan"></StepperContentHeader>
        <StepperContentBody
            ><div class="flex w-full flex-col gap-2">
                ...
                />
                <SectionHeader title="Keputusan Permohonan Penaungguhan/Pindaan Penempatan" />
                <TextField label="Nama Pelulus" disabled={false} placeholder="-"
                ></TextField>
                <TextField
                    label="Keputusan"
                    disabled={true}
