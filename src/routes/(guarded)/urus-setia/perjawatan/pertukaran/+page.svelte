        ...
        <TabContent title="Permohonan Sendiri">
            ...
            <div class="w-full">
                <DynamicTable
                    ...
                    detailActions={() => {
                        goto(
                            '/urus-setia/perjawatan/pertukaran/permohonan-sendiri/butiran',
                        );
                    }}
                />
            </div>
        ...
        <TabContent title="Arahan Pengarah Bahagian/Negeri">
            ...
            <div class="w-full">
                <DynamicTable
                    ...
                    detailActions={() => {
                        goto(
                            '/urus-setia/perjawatan/pertukaran/arahan-pengarah/butiran',
                        );
                    }}
                />
            </div>
        ...
        <TabContent title="Arahan Pihak Pengurusan">
            <SectionHeader title="Senarai Rekod Permohonan Pertukaran"
                ><FormButton
                    ...
                    onClick={() => {
                        goto('pertukaran/arahan-pengurusan/baru');
                    }}
                /></SectionHeader
            >
            <div class="w-full">
