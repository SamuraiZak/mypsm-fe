...
<section class="flex w-full flex-col items-start justify-start">
    <ContentHeader
        title="Kemaskini Sejarah APC {noPekerja}"
        description="Penambahan rekod penerima Anugerah Pekerja Cemerlang (APC) {data
            .record.currentEmployee.name}"
    >
        <FormButton
            type="close"
            onClick={() => {
...
<Stepper activeIndex={activeStepper}>
    ...
    <StepperContent>
        <StepperContentHeader title="Tahun Terima APC">
