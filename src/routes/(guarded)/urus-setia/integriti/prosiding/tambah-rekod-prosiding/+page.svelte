...
<section class="flex w-full flex-col items-start justify-start">
    <ContentHeader
        ...
        description="Pilih Kakitangan untuk teruskan proses tambah rekod prosiding tatatertib."
        ><TextIconButton
            label="Kembali"
            onClick={() => {
                goto('../prosiding');
...
>
    ...
    >
        ...
        <div class="flex max-h-full w-full flex-col items-start justify-start">
            <SectionHeader title="Senarai Hasil Carian"></SectionHeader>
            <DynamicTable
                ...
                editActions={() => {
                    const url =
                        './tambah-rekod-prosiding/butiran-' +
